...
export default function MeetingCreate({ employees }: Props) {
    ...
    const addAttendee = () => {
        setAttendees([...attendees, { user_id: '', status: 'present' }]);
    };
    ...
    const addAgenda = () => {
        setAgendas([...agendas, { title: '', presenter_id: '' }]);
    };
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-3 mt-6">
                                    ...
                                    >
                                        ...
                                        {processing ? 'Saving...' : 'Create Meeting'}
                                    </button>
                                    <Link
                                        href="/management/meetings"
