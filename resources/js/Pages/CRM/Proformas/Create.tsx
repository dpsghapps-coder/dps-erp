...
export default function ProformaCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/crm/${client?.id}/proformas`);
    };

    return (
        <AppLayout>
            <Head title={`New Proforma — ${client?.company_name}`} />
            ...
            <PageHeader title="New Proforma" subtitle={`For ${client?.company_name}`} />
                    ...
                    <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div key={index} className="grid grid-cols-12 gap-2 items-start p-3 bg-slate-50 dark:bg-white/5 rounded-lg">
                                        ...
                                        <div className="col-span-1 flex items-center justify-center pt-2">
                                            <button
                                                ...
                                                className="p-1 rounded hover:bg-slate-100 dark:hover:bg-white/10 text-slate-400 hover:text-red-400 transition-colors disabled:opacity-30"
                                            >
                        ...
                        <GlassCard>
                            ...
                            <textarea
                                ...
                                className="glass-input w-full h-32 text-sm"
